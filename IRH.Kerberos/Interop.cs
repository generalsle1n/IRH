...
namespace IRH.Kerberos
{
    public class Interop
    {
        ...
        public enum KERBEROS_ERROR : UInt32
        {
            ...
            KDC_ERR_DH_KEY_PARAMETERS_NOT_ACCEPTED = 0x41,
            ...
            KRB_AP_ERR_PRINCIPAL_UNKNOWN = 0x52,
            KRB_AP_ERR_REALM_UNKNOWN = 0x53,
            KRB_AP_ERR_PRINCIPAL_RESERVED = 0x54,
            KDC_ERR_PREAUTH_EXPIRED = 0x5A,
            KDC_ERR_MORE_PREAUTH_DATA_REQUIRED = 0x5B,
            KDC_ERR_PREAUTH_BAD_AUTHENTICATION_SET = 0x5C,
